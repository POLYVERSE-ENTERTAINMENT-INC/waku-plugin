...
2. Route to the specialist skills immediately after classification:
   - Shared architecture and engine choice: `skills/web-game-foundations/web-game-foundations.md`
   - Deep 2D implementation: `skills/phaser-2d-game/phaser-2d-game.md`
   - Vanilla Three.js implementation: `skills/three-webgl-game/three-webgl-game.md`
   - React-hosted 3D implementation: `skills/react-three-fiber-game/react-three-fiber-game.md`
   - 3D asset shipping and optimization: `skills/web-3d-asset-pipeline/web-3d-asset-pipeline.md`
   - HUD and menu direction: `skills/game-ui-frontend/game-ui-frontend.md`
   - 2D sprite generation and normalization: `skills/sprite-pipeline/sprite-pipeline.md`
   - Browser QA and visual review: `skills/game-playtest/game-playtest.md`
