...
Use this skill when the project wants direct scene, camera, renderer, and game-loop control. If the app already lives in React, route to `../react-three-fiber-game/react-three-fiber-game.md` instead.
...
- Shared architecture: `../web-game-foundations/web-game-foundations.md`
- Frontend direction: `../game-ui-frontend/game-ui-frontend.md`
