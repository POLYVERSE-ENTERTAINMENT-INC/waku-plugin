...
This skill is 2D-specific. If the request is for 3D characters, meshes, or materials, route back through `../../SKILL.md`.
...
This skill defines the game-specific sprite process (seed frame, whole-strip generation, normalization); it does not bind to a specific image-generation backend. Use whatever image-generation capability your host or workspace provides — an installed image-generation skill or the host platform's multimodal tooling — to execute the actual full-strip generation and edits.
...
- Shared frontend context: `../game-ui-frontend/game-ui-frontend.md`
